...
<style>
    ...
    .section-box {padding: 0;margin-bottom: 1rem;border: solid 1px #40004c;border-radius: 10px;overflow: hidden;}
    ...
    .section-box form {padding: 1rem;transition: cubic-bezier(0.22, 0.61, 0.36, 1) 0.7s}
