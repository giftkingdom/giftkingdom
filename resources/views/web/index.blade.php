                ...
                <div class="hero-slider">
                    ...
                    <?php
                      foreach($data['banners'] as $banner ) :?>
                        ...
                        <div>
                            <figure>
                                <img src="<?=asset($banner['featured_image'])?>" alt="*" class="w-100 d-none d-md-block">
                                ...
                                <figcaption class="position-absolute d-flex align-items-md-center top-0 bottom-0 start-0 end-0">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <h2 class="mb-3"><?=$banner['post_title']?></h2>
                                                <?=$banner['post_content']?>
                                                <a href="<?=$banner['metadata']['button_link']?>" class="btn"><?=$banner['metadata']['button_text']?> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 7.57692L12.3814 7.57692L7.9322 3.13462L8.49153 2.5L14 8L8.49153 13.5L7.9322 12.8654L12.3814 8.42308L2 8.42308L2 7.57692Z" fill="#6D7D36"/></svg>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row g-4">
            ...
            foreach($data['categories'] as $cat) : ?>
                ...
                <div class="col-sm-6 col-lg-4">
                    <a href="<?=asset('shop/category/'.$cat['categories_slug'])?>" class="wow product-card fadeInUp d-flex gap-4 align-items-center justify-content-between py-3 px-4">
...
$slug = asset($cat['categories_slug']);
            ...
            ?>
                ...
                <div class="">
                    <a href="<?=$slug?>" class="wow product-card fadeInUp d-flex gap-4 align-items-center justify-content-between py-3 px-4">
                        <h5 class="mb-0"><?=$cat['category_title']?></h5>
...
<section class="main-section cta-bar py-0 py-lg-4 home-sec-bar">
    <div class="container">
        <aside class="d-flex justify-content-between align-items-center overflow-hidden flex-wrap">
            ...
            <a href="{{$data['content']['home_s7_btn_link']}}" class="btn wow fadeInUp"><?=$data['content']['home_s7_btn_text']?> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 7.57692L12.3814 7.57692L7.9322 3.13462L8.49153 2.5L14 8L8.49153 13.5L7.9322 12.8654L12.3814 8.42308L2 8.42308L2 7.57692Z" fill="#6D7D36"/></svg></a>
        </aside>
